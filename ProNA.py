...
for i in range(len(ynew_df)):
    ...
    result.columns=["sRNA ID","Protein ID","Probability of interaction","Propability of non-interaction"]
    result_sorted = result.sort_values(by="Probability of interaction",ascending=False)
